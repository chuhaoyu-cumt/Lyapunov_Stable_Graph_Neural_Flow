...
def main():
    ...
    parser.add_argument('--eval_attack', type=str, default="seqgia") #pgd
    ...
    parser.add_argument('--attack_epoch', type=int, default=5) #500
    # attack A_atk update epochs
    parser.add_argument('--agia_epoch', type=int, default=3) #300
    ...
    parser.add_argument('--early_stop', type=int, default=2) #200
    ...
    parser.add_argument('--injection', type=str, default="meta")#random
    ...
    # ODE args
    parser.add_argument('--time',default=40,  type=float, help='End time of ODE integrator.')
    ...
    parser.add_argument('--epoch', type=int, default=4, help='Number of training epochs per iteration.')#400
    parser.add_argument('--alpha', type=float, default=1.0, help='Factor in front matrix A.')
    parser.add_argument('--alpha_dim', type=str, default='sc', help='choose either scalar (sc) or vector (vc) alpha')
    parser.add_argument('--no_alpha_sigmoid', dest='no_alpha_sigmoid', action='store_true',
                    help='apply sigmoid before multiplying by alpha')
    parser.add_argument('--beta_dim', type=str, default='sc', help='choose either scalar (sc) or vector (vc) beta')
    parser.add_argument('--block', default='att_frac',type=str,  help='constant_graph,constant, mixed, attention, hard_attention')#constant_frac:ConstantODEblock_FRAC   att_frac:AttODEblock_FRAC 
    parser.add_argument('--function',default='transformer', type=str, help='laplacian, transformer, dorsey, GAT') #transgraphcon:ODEFuncAtt_graphcon   transformer:ODEFuncTransformerAtt
    ...
    parser.add_argument('--alpha_ode', type=float, default=0.15, help='alpha_ode')
    ...
    if args.dataset.lower() == 'arxiv':
        ...
        dataset = Planetoid('/amax/home/chenxiaotong/chenxiaotong/chy/Frond_laya_remix1_Cora/data/Cora/', 'Cora', transform=transform)
        data = dataset[0]
        data.adj_t = data.adj_t.to_symmetric()
        num_classes = dataset.num_classes
    else:
    ...
    model =  GNN(args, dataset, device).to(device)
    print(model)
    data = data.to(device)
